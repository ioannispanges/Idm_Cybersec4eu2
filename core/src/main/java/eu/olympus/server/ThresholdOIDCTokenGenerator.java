...
public class ThresholdOIDCTokenGenerator implements TokenGenerator {
	...
	private void populateAttributes(JSONObject json, String username, Policy policy) throws PolicyUnfulfilledException {
	...
	private String buildJWTPayload(String username, Policy policy, String id) throws PolicyUnfulfilledException {
